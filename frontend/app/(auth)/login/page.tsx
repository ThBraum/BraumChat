                        ...
                        <div className="grid gap-6 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm sm:grid-cols-2">
                            ...
                            <div className="grid gap-4 min-w-0 sm:grid-cols-3">
                                {stats.map((stat) => {
                                    ...
                                    const cardClasses = `rounded-2xl border border-white/10 bg-white/5 p-6 text-center flex flex-col items-center justify-center min-h-[5.25rem] w-full overflow-hidden ${
                                        hasDetail
                    ...
                    <section>
                        <Card className="border-white/10 bg-slate-950/70 shadow-2xl backdrop-blur">
                            <CardHeader className="space-y-2">
                                <CardTitle className="text-3xl text-white">{t("auth:login.title")}</CardTitle>
